        ...
        try {
            ...
            const result = await pool.request()
                ...
                .query(`
                    ...
                    SELECT DISTINCT A.CODARTICULO, A.REFPROVEEDOR, ACL.DESCRIPCIONLARGA DESCRIPCION, ACL.PRINCIPIOACTIVO, CASE WHEN A.SECCION = 12 THEN 'T' ELSE 'F' END ES_PSICOTROPICO, ISNULL((SELECT 
